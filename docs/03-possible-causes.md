...
GitHub 官方明确表示，会对违反 [Acceptable Use Policies](https://docs.github.com/en/site-policy/acceptable-use-policies/github-acceptable-use-policies) 的内容或行为采取 enforcement action，包括：
...
**常见场景**：
- 短时间内创建大量仓库或 fork / 镜像（例如：跨账号大批量迁移/镜像上百个仓库）
- 大量发送 Issue / PR / 评论
