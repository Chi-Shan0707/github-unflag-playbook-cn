...
|---|----------|--------|-----------------|-----------------|------------------|-------------|-----------------|---------------|-----------------|
| 1 | [chi-shan0707](/cases/chi-shan0707/) | Mainland China | 2025-04 | Profile 404, contributions disappeared | Failed | Yes | Recovered | - | Suspected high-frequency API / Agent activity triggered risk control |

---

## How to Submit Your Case

1. Copy the [case template](/cases/template/)
