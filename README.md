...
| # | 章节 | 说明 |
|---|------|------|
| 1 | [什么是 flag](docs/01-what-is-flag.md) | flag 的定义、类型、与 suspension 的区别 |
| 2 | [被 flag 的常见现象](docs/02-symptoms.md) | 高置信现象 + 社区反复报告现象 |
...
- **不提供黑灰产方法**：所有建议基于官方流程和社区公开经验
- **只记录公开信息或经本人授权的信息**：案例库中每条记录均经当事人同意
